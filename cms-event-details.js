...
import '@smyd/app-overlays/app-modal.js';
import '@smyd/app-overlays/app-spinner.js';
import '@smyd/cms-elements/cms-icons.js';
import '@smyd/cms-elements/image-editor.js';
...
class CmsEventDetails extends AppElement {
  ...
  async __openPreviewDetails(event) {
    await import('@smyd/asg-event-shared-elements/event-details.js');
